...
BLOG_AUTHOR = "Onéira"  # (translatable)
BLOG_TITLE = "La Minute Culturelle"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.mad-scientists.net/la-minute-culturelle/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.mad-scientists.net/la-minute-culturelle/"
BLOG_EMAIL = "oneira@mad-scientists.net"
BLOG_DESCRIPTION = "Votre shot culture du jour!"  # (translatable)
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -av -6 --delete output/ lyly@mad-scientists.net:/srv/KriekData1/net.mad-scientists/la-minute-culturelle",
        ]
}
...
SCHEDULE_RULE = 'RRULE:FREQ=DAILY;BYHOUR=17;BYMINUTE=0;BYSECOND=0'
